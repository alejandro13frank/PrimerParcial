...
int main()
{
    ...
    strncpy(arrayInstrumento[1].nombre,"inst1",sizeof(arrayInstrumento[1].nombre));
    arrayInstrumento[1].tipo=1;

    arrayInstrumento[2].idUnico=2;
    arrayInstrumento[2].isEmpty=0;
    strncpy(arrayInstrumento[2].nombre,"inst2",sizeof(arrayInstrumento[2].nombre));
    arrayInstrumento[2].tipo=2;

    arrayInstrumento[3].idUnico=3;
    arrayInstrumento[3].isEmpty=0;
    strncpy(arrayInstrumento[3].nombre,"inst3",sizeof(arrayInstrumento[3].nombre));
    arrayInstrumento[3].tipo=2;

    arrayInstrumento[4].idUnico=4;
    arrayInstrumento[4].isEmpty=0;
    strncpy(arrayInstrumento[4].nombre,"inst4",sizeof(arrayInstrumento[4].nombre));
